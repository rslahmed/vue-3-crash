  ...
  <div @click.self="show = false" v-show="show" class="fixed inset-0 z-50 bg-black/30">
    <div class="absolute h-full w-72 bg-cyan-700 overflow-y-auto right-0 top-0 flex flex-col">
      ...
      <div class="mt-2 divide-y divide-gray-300/20">
        <div v-for="n in 3" class="flex px-4 py-2">
          <div class="flex-shrink-0 w-12 mr-3">
            <img src="/images/car-1.jpg" alt="" class="w-full h-12 object-cover rounded">
          </div>
          <div class="flex-grow">
            <h4 class="font-semibold text-white">Red Car</h4>
            <p class="text-gray-300">x2</p>
          </div>
          <div class="flex-shrink-0 text-right">
            ...
            <h4 class="font-semibold text-white">$40.00</h4>
          </div>
        </div>
      </div>
